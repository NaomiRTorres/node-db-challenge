...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  RDs manages storage, querying, updating and pretty much everything.
  SQL is a language that is typically used to query RDs.
...
There's a technique called a 'junction table' and with that we link multiple tables to each other.
